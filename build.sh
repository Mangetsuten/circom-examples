...
if [[ "$CUSTOM_PTAU" == "y" || "$CUSTOM_PTAU" == "Y" ]]; then
    PTAU_FILE="phase1_pot14_final.ptau"
    if [[ -f "$PTAU_FILE" ]]; then
        ...
        snarkjs powersoftau new bn128 14 phase1_pot14_00.ptau -v
        snarkjs powersoftau contribute phase1_pot14_00.ptau phase1_pot14_01.ptau --name="First contribution" -v -e="Random text 1"
        snarkjs powersoftau contribute phase1_pot14_01.ptau phase1_pot14_02.ptau --name="Second contribution" -v -e="Random text 2"
        snarkjs powersoftau export challenge phase1_pot14_02.ptau phase1_challenge_03
        snarkjs powersoftau challenge contribute bn128 phase1_challenge_03 phase1_response_03 -e="Random Text"
        snarkjs powersoftau import response phase1_pot14_02.ptau phase1_response_03 phase1_pot14_03.ptau -n="Third contribution"
        snarkjs powersoftau beacon phase1_pot14_03.ptau phase1_pot14_beacon.ptau 0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f 10 -n="Final Beacon"
        snarkjs powersoftau prepare phase2 phase1_pot14_beacon.ptau phase1_pot14_final.ptau -v
        snarkjs powersoftau verify phase1_pot14_final.ptau
    fi
else
    ...
    if [[ -f "$PTAU_FILE" ]]; then
        ...
        wget -O powersOfTau28_hez_final_15.ptau https://storage.googleapis.com/zkevm/ptau/powersOfTau28_hez_final_15.ptau
    fi
fi
